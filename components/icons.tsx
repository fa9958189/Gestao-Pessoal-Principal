...
export function WhatsAppIcon({ className = "w-6 h-6" }: { className?: string }) {
  return (
    <svg className={className} viewBox="0 0 32 32" fill="currentColor" aria-hidden="true">
      <path d="M16.04 3C9.42 3 4 8.28 4 14.77c0 2.48.76 4.79 2.07 6.7L4.24 29l7.77-2.26a12.1 12.1 0 0 0 3.98.65C22.62 27.39 28 22.11 28 15.62 28 9.13 22.66 3 16.04 3Zm0 21.6c-1.24 0-2.45-.22-3.6-.67l-.26-.1-4.61 1.34 1.33-4.48-.12-.28a9.62 9.62 0 0 1-1.1-4.63c0-5.17 4.12-9.37 9.2-9.37 5.07 0 9.2 4.2 9.2 9.37 0 5.17-4.13 9.37-9.2 9.37Zm5.39-7.03c-.3-.15-1.78-.88-2.06-.98-.28-.1-.48-.14-.68.14-.2.28-.78.97-.95 1.17-.18.2-.35.22-.64.07-.3-.15-1.25-.46-2.38-1.46-.88-.78-1.47-1.74-1.64-2.02-.17-.29-.02-.44.13-.59.14-.14.3-.36.45-.54.15-.18.2-.28.3-.47.1-.2.05-.37-.02-.52-.07-.15-.68-1.61-.93-2.21-.25-.6-.5-.5-.68-.51h-.58c-.2 0-.52.07-.8.37-.28.3-1.05 1-.95 2.45.1 1.45 1.06 2.88 1.21 3.08.15.2 2.1 3.36 5.18 4.68 3.08 1.32 3.08.88 3.64.83.56-.05 1.78-.72 2.03-1.42.25-.7.25-1.3.18-1.42-.07-.12-.27-.2-.57-.35Z" />
    </svg>
  );
}
